...
class ClientTest(unittest.TestCase):
    ...
    # Tests when the first price (numerator) is zero
    def test_getRatio_calculateFirstPriceZero(self):
        quotes = [
    ...
    # Tests when the second price (denominator) is zero
    def test_getRatio_calculateSecondPriceZero(self):
        quotes = [
            {'top_ask': {'price': 121.2, 'size': 36}, 'timestamp': '2019-02-11 22:06:30.572453',
             'top_bid': {'price': 120.48, 'size': 109}, 'id': '0.109974697771', 'stock': 'ABC'},
